...
import { Language, Slideshow, ArrowDropDown } from '@mui/icons-material'
...
const NavLinks = ({ onToggleMenu }) => {
	const { version, setVersion, setLanguage } = useContext(AppContext)
			...
			{/* <Box>
				...
				<Menu
					...
					{versions.map(version => (
						<MenuItem key={version} onClick={() => handleVersionChange(version)}>{version}</MenuItem>
					))}
